                            ...
                            <v-tabs-window v-model="tab" style="padding: 1em;">
                                ...
                                <!-- <v-tabs-window-item>
                                    ...
                                    <v-radio-group 
                                        ...
                                        inline>
                                        <v-radio name="goSearchType" label="Include lower GO lineage" value="lower" theme="dark"></v-radio>
                                        <v-radio name="goSearchType" label="Exact GO term" value="exact" theme="dark"></v-radio>
                                    </v-radio-group>
                                </v-tabs-window-item> -->
                                <v-tabs-window-item>
                                    <TaxonomyNcbiSearch
                                    ...
                                    <v-radio-group 
                                        ...
                                        inline>
                                        <v-radio name="lcaSearchType" label="Include lower LCA lineage" value="lower" theme="dark"></v-radio>
                                        <v-radio name="lcaSearchType" label="Exact LCA identifier" value="exact" theme="dark"></v-radio>
                                    </v-radio-group>
                                </v-tabs-window-item>
                                <v-tabs-window-item>
                                    <FoldseekSearchButton @response="searchFoldseek($event)" theme="dark"></FoldseekSearchButton>
                                </v-tabs-window-item>
                            </v-tabs-window>
                        </v-col>
                    </v-row>
...
import bgImage from './assets/BFVD-bg.png';
